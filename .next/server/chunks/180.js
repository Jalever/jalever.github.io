...
const _nexturl = __webpack_require__(5398);
const _utils = __webpack_require__(1634);
const _error = __webpack_require__(6466);
const _cookies = __webpack_require__(7078);
...
const serverExports = {
    NextRequest: (__webpack_require__(7949).NextRequest),
    NextResponse: (__webpack_require__(3251)/* .NextResponse */ .x),
    ImageResponse: (__webpack_require__(1075)/* .ImageResponse */ .E),
    userAgentFromString: (__webpack_require__(2122).userAgentFromString),
    userAgent: (__webpack_require__(2122).userAgent)
};
